...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = "ShopLocator",
        defaults = {
            ...
            infoBubble:{
                ...
                closeSrc: urlPath+"src/style/closeButton.svg",
                offsetTop: 2,
                offsetRight: 2,
            ...
            sidebar:{
                ...
                selectSection:{
                    visible: false,
                    pathToJSONDirectory: urlPath+"src/json/",
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            var src = urlPath+"src/dependences/markerclusterer.js";
            var src2 = urlPath+"src/dependences/infobubble.js";
