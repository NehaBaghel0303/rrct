var side_bar_html = ""; 
  ...
  google.maps.event.addListener(map, 'click', function() {
        ...
        const waypts = [];
         ...
         waypts.push({
                location: "23.43847140823324, 79.79630493564669",
                stopover: true,
            });
        
				var request = { 
					origin: "23.456820431062813, 79.80678133038633", 
					destination: "23.41524405997725, 79.79677153521172", 
          waypoints: waypts,
...
var icons = new Array();
icons["red"] = new google.maps.MarkerImage("https://lh3.googleusercontent.com/a-/AFdZucqvnz8C-312zXQt57mUCGvlem_zYyKJSYlJ6V1N2w=s40-c",
...
function getMarkerImage(iconColor) {
   ...
   if (!icons[iconColor]) {
      icons[iconColor] = new google.maps.MarkerImage("https://lh3.googleusercontent.com/a-/AFdZucqvnz8C-312zXQt57mUCGvlem_zYyKJSYlJ6V1N2w=s40-c",
      // This marker is 20 pixels wide by 34 pixels tall.
      new google.maps.Size(20, 34),
      // The origin for this image is 0,0.
      new google.maps.Point(0,0),
