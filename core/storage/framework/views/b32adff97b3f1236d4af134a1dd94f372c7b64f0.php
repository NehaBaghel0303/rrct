...
<?php $__env->startSection('title', 'Lorry Receipt'); ?>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="d-flex">
                            ...
                            <div>
                                <h5 class="mb-0"><?php echo e($lorry_receipt->lr_no); ?></h5>
                                <span class="text-muted"><?php echo e(getFormattedDate($lorry_receipt->created_at)); ?></span>
                                <div class="mt-2">
                                    <span class="badge badge-<?php echo e(lorryReceiptStatus($lorry_receipt->status)['color']); ?>"><?php echo e(lorryReceiptStatus($lorry_receipt->status)['name']); ?></span>
                                </div> 
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                <div class="">
                                    ...
                                    <div class="lr-details-wrapper">
                                        <span class=""><?php echo e($payload->lr_details->originDetails->consignor); ?></span>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="">
                                    ...
                                    <div class="lr-details-wrapper">
                                        <span><?php echo e($payload->lr_details->destinationDetails->consignee); ?></span>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="">
                                    ...
                                    <div class="lr-details-wrapper">
                                        <span class=""><?php echo e($payload->branch); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="lr-details-wrapper">
                                        <span><?php echo e($lorry_receipt->invoice_no); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="lr-details-wrapper">
                                        <span><?php echo e($lorry_receipt->shipment_no); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="d-flex">
                                    ...
                                    <div class="pl-2 lr-details-wrapper">
                                        <span class="pl-2"><?php echo e($payload->lr_details->ewb_no); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                                    ...
                                    <div class="cards">
                                        <div class="card mb-0" style="background:#e1fae3;margin-top: 46px;">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="mr-3"><?php echo e(getFormattedDate(now())); ?></div>
                                            </div>
                                            <p><?php echo e($payload->lr_details->originDetails->from_place); ?></p>
                                        </div>
                                        ...
                                        <div class="card" style="background-color: #d3eef0;">
                                            ...
                                            <p><?php echo e($payload->lr_details->destinationDetails->to_place); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card card-body" style="background: #fffbce54;">
                            ...
                            <div class="remark-card mb-2 <?php if($remarks->count() <= 0): ?> d-flex justify-content-center align-items-center <?php endif; ?>" style="height: 300px;">
                                ...
                                ?>
                                    <div class="card mb-2">
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <img src="<?php echo e(($user && $user->avatar) ?asset($user->avatar) : asset('backend/default/default-avatar.png')); ?>" class="remark-image"  alt="">
                                                <div class="ml-3" style="width: 26vw;">
                                                    ...
                                                    <small><i class="fa fa-clock mr-1"></i><?php echo e($remark->created_at->diffForHumans()); ?></small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>   
                                    <div class="text-center">
                                        <img src="<?php echo e(asset('backend/img/boxes.png')); ?>" alt="">
                                        <p class="text-muted py-2">No Remarks!</p>
                                        
                                    </div>
                                <?php endif; ?>
                            </div>
                            <form action="<?php echo e(route('panel.report.remark.store')); ?>" method="post" id="remarkForm" class="">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" value="0" name="id" id="remarkId"> 
                                <input type="hidden" value="<?php echo e($lorry_receipt->id); ?>" name="lorry_receipt_id"> 
...
<?php echo $__env->make('backend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\projects\rrct\core\resources\views/panel/lorry_receipts/show.blade.php ENDPATH**/ ?>