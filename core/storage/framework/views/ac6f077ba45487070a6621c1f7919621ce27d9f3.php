...
<div style="display: none;">
    <audio class="win-play" controls autoplay>
        <source src="<?php echo e(asset('backend/audio/ubi_soft.mp3')); ?>" type="audio/mpeg">
    </audio>
    ...
    <div class="bg-overlay"></div>
        <div class="container">
            <div id="pot" class="text-center">
                <img src="<?php echo e(asset('frontend/assets/images/sound-logo.png')); ?>" class=" mb-4 d-block mx-auto" alt="website-logo" style="height:45%;width: 50%;filter: invert(1);opacity: 0.7;"> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.intro', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\projects\rrct\core\resources\views/frontend/introduction.blade.php ENDPATH**/ ?>