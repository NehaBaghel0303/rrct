    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-12 pr-2">
                <?php echo $__env->make('backend.track.include.vehicle-details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <div class="col-lg-9 col-md-6 col-sm-12">
                <div class="card " style="background: none;box-shadow:none;">
                    <div class="card-body m-0 p-0">
                        <?php echo $__env->make('backend.track.include.vehicle-trip', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <div class="row">
                            <div class="col-lg-8 p-1">
                                <?php echo $__env->make('backend.track.include.map', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div class="col-lg-4 p-1">
                                <?php echo $__env->make('backend.track.include.trip-details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
function initMap() {
  ...
  const image = {
    url: "<?php echo e(asset('backend/img/trucks/green-truck-01.png')); ?>",
...
//            map: map,
//            icon:  "<?php echo e(asset('backend/img/location_dot_blue.png')); ?>",
//            position: points[i],
//            title: i+1+" mile"
//          });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.track', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\projects\rrct\core\resources\views/backend/track/show.blade.php ENDPATH**/ ?>