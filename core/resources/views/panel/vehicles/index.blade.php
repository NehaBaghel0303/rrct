 ...
 */
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('panel.vehicles.index') }}" method="GET" id="TableForm">
            <div class="row">
                <!-- start message area-->
                <!-- end message area-->
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="d-flex justicy-content-right">
                                ...
                                <a href="javascript:void(0);" id="reset" data-url="{{ route('panel.vehicles.index') }}" class="btn btn-icon btn-sm btn-outline-danger mr-2" title="Reset"><i class="fa fa-redo" aria-hidden="true"></i></a>
                                                                <a href="{{ route('panel.vehicles.create') }}" class="btn btn-icon btn-sm btn-outline-primary" title="Add New Vehicle"><i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                        <div id="ajax-container">
                            @include('panel.vehicles.load')
                        </div>
                    </div>
                </div>
            </div>
