...
*/
$breadcrumb_arr = [
    ['name'=>'Edit Vehicle', 'url'=> "javascript:void(0);", 'class' => '']
]
@endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Edit Vehicle</h5>
                            <span>Update a record for Vehicle</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-8 mx-auto">
               ...
               @include('backend.include.message')
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{ route('panel.vehicles.update',$vehicle->id) }}" method="post" enctype="multipart/form-data" id="VehicleForm">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('vehicle_no') ? 'has-error' : ''}}">
                                        ...
                                        <input required   class="form-control" name="vehicle_no" type="number" id="vehicle_no" value="{{$vehicle->vehicle_no }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('image') ? 'has-error' : ''}}">
                                        ...
                                        <img id="image" src="{{ asset('storage/backend/vehicle/'.$vehicle->image) }}" class="mt-2" style="border-radius: 10px;width:100px;height:80px;"/>
                                    </div>
                                </div>
