 ...
 */
$breadcrumb_arr = [
    ['name'=>'Add Device Log', 'url'=> "javascript:void(0);", 'class' => '']
]
@endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Add Device Log</h5>
                            <span>Create a record for Device Log</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-8 mx-auto">
               ...
               @include('backend.include.message')
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{ route('panel.device_logs.store') }}" method="post" enctype="multipart/form-data" id="DeviceLogForm">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('lr_id') ? 'has-error' : ''}}">
                                        ...
                                        <input required  class="form-control" name="lr_id" type="text" id="lr_id" value="{{old('lr_id')}}" placeholder="Enter Lr Id" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('lat') ? 'has-error' : ''}}">
                                        ...
                                        <input required  class="form-control" name="lat" type="date" id="lat" value="{{old('lat')}}" placeholder="Enter Lat" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('lon') ? 'has-error' : ''}}">
                                        ...
                                        <input required  class="form-control" name="lon" type="date" id="lon" value="{{old('lon')}}" placeholder="Enter Lon" >
                                    </div>
                                </div>
