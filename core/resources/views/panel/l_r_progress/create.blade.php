 ...
 */
$breadcrumb_arr = [
    ['name'=>'Add L R Progress', 'url'=> "javascript:void(0);", 'class' => '']
]
@endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Add L R Progress</h5>
                            <span>Create a record for L R Progress</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
               ...
               @include('backend.include.message')
                ...
                <div class="card ">
                    <div class="card-header">
                        <h3>Create L R Progress</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('panel.l_r_progress.store') }}" method="post" enctype="multipart/form-data" id="LRProgresForm">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('distance_covered') ? 'has-error' : ''}}">
                                        ...
                                        <input required  class="form-control" name="distance_covered" type="text" id="distance_covered" value="{{old('distance_covered')}}" placeholder="Enter Distance Covered" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('distance_remain') ? 'has-error' : ''}}">
                                        ...
                                        <input required  class="form-control" name="distance_remain" type="text" id="distance_remain" value="{{old('distance_remain')}}" placeholder="Enter Distance Remain" >
                                    </div>
                                </div>
