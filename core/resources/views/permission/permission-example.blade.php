                    ...
                    <div class="card-body">
                            <div class="row">
                                <div class="col-md-10 p-3">
                                    ...
                                    <img src="{{ asset('backend/img/blade-syntax.JPG')}}" alt="" class="img-fluid"> <br><br>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>{{ __('Iphone 6')}}</td>
                                        <td><img src="{{ asset('backend/img/widget/p2.jpg')}}" alt="" class="img-fluid img-20"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>{{ __('Jacket')}}</td>
                                        <td><img src="{{ asset('backend/img/widget/p3.jpg')}}" alt="" class="img-fluid img-20"></td>
                                        <td>
                                            <div class="p-status bg-green"></div>
                                        </td>
                                        <td>$35</td>
                                    ...
                                    <tr>
                                        <td>{{ __('Sofa')}}</td>
                                        <td><img src="{{ asset('backend/img/widget/p4.jpg')}}" alt="" class="img-fluid img-20"></td>
                                        <td>
                                            <div class="p-status bg-green"></div>
                                        </td>
                                        <td>$85</td>
                            ...
                            <div class="latest-update-box">
                                <div class="row pt-20 pb-30">
                                    <div class="col-auto text-right update-meta pr-0">
                                        <img src="{{ asset('backend/img/users/4.jpg')}}" alt="user image" class="rounded-circle img-40 align-top mr-15 update-icon">
                                    </div>
                                    <div class="col pl-5">
                ...
                <div class="card">
                    ...
                    <div class="card-block widget-last-task">
                        ...
                        <ul class="list-unstyled mb-20">
                            <li class="d-inline-block"><img src="{{ asset('backend/img/users/2.jpg')}}" alt="user-image" class="rounded-circle img-30 mr-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="{{ asset('backend/img/users/3.jpg')}}" alt="user-image" class="rounded-circle img-30 mr-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="{{ asset('backend/img/users/2.jpg')}}" alt="user-image" class="rounded-circle img-30 mr-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                        </ul>
                        ...
                        <ul class="list-unstyled mb-20">
                            <li class="d-inline-block"><img src="{{ asset('backend/img/users/4.jpg')}}" alt="user-image" class="rounded-circle img-30 mr-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="{{ asset('backend/img/users/2.jpg')}}" alt="user-image" class="rounded-circle img-30 mr-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                            <li class="d-inline-block"><img src="{{ asset('backend/img/users/3.jpg')}}" alt="user-image" class="rounded-circle img-30 mr-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"></li>
                        </ul>
                        <p class="mb-10">{{ __('New Dashboard')}} <span class="float-right text-muted f-14">{{ __('5 Mins ago')}}</span></p>
                        ...
                        <div class="review-block">
                            <div class="row">
                                <div class="col-sm-auto pr-0">
                                    <img src="{{ asset('backend/img/users/2.jpg')}}" alt="user image" class="rounded-circle profile-img cust-img mb-15">
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col-sm-auto pr-0">
                                    <img src="{{ asset('backend/img/users/1.jpg')}}" alt="user image" class="rounded-circle profile-img cust-img mb-15">
                                </div>
                                <div class="col">
                                    <h6 class="mb-15">{{ __('John Deo')}}</h6>
                                    <div class="row align-items-center">
