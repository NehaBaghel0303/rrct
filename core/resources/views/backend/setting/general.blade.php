                    ...
                    <div role="tabpanel">
                        <div class="card-header" style="border:none;">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                {{-- <li class="nav-item">
                                    <a href="#cron-logics" class="nav-link" aria-controls="cron-logics" role="tab"
                                        data-toggle="tab">Cron Logics</a>
                                </li> --}}
                            </ul>
                        </div>
                            ...
                            <div class="tab-content">
                                ...
                                <!--tab panel trip-logics-->
                                    <div role="tabpanel" class="tab-pane fade show pt-3" id="trip-logics"
                                        ...
                                        <form action="{{ route('panel.setting.trip_logics.store') }}" method="post"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="group_name" value="{{ 'trip_logics' }}">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control" id="" name="delay_eta" placeholder="Delay ETA" value="{{ getSetting('delay_eta') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control" id="" name="delay_loading_point" placeholder="Delay at Loading Point" value="{{ getSetting('delay_loading_point') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control" id="" name="delay_unloading_point" placeholder="Delay at Unloading Point" value="{{ getSetting('delay_unloading_point') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control" id="" name="delay_enroute" placeholder="Delay at En-Route" value="{{ getSetting('delay_enroute') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control" id="" name="delay_new_loading" placeholder="Delay for new Loading" value="{{ getSetting('delay_new_loading') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                aria-labelledby="google-map-tab">
                                    <form class="forms-sample" action="{{ route('panel.setting.google_map.store') }}"
                                        method="post">
                                        @csrf
                                        <input type="hidden" name="group_name" value="{{ 'gmap_api_key' }}">
                                        <div class="form-group row">
                                            <label for="exampleInputUsername2"
                                                class="col-sm-3 col-form-label">{{ __('Google Map API') }}<span class="text-red">*</span>
                                            </label>
                                            <div class="col-sm-9">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="gmap_api" value="{{ getSetting('gmap_api') }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer text-right">
