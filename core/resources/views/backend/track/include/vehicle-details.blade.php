...
<div class="card" style="margin-bottom:10px;">
    <div class="card-header d-flex justify-content-between" style="background-color: #1a237e;">
        <h3 class="vehicle-number text-white">{{$v_id}}</h3>
    ...
    <div class="card-body p-2">
        <div class="d-flex justify-content-between">
            <div class="d-flex">
                <div class="icon-wrapper">
                    <img src="{{ asset('backend/img/driver-shape.svg') }}" style="height:25px;" alt="">
                </div>
       ...
       <div class="d-flex">
            <div class="icon-wrapper">
                <img src="{{ asset('backend/img/vehicle-truck.svg') }}" style="height:22px;" alt="">
            </div>
            <div style="line-height: 14px;">
                <div>
                    {{-- @dd($payload) --}}
                    <small class="text-muted d-block">
                        {{-- Vehicle - W{{ $payload->vehicleDetails->wheeler }} --}}
                    </small>
                    {{-- {{ $payload->truck_type }} --}}
                </div>
                <h6 class="mb-0">
...
<div class="card">
    <div class="card-body d-flex justify-content-between ptb15_20">
       <div class="">
            <img src="{{ asset('backend/img/fuel.svg') }}" alt="fuel" width="33"height="45">
       </div>
       <div>
