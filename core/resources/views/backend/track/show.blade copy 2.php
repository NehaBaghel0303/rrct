...
<script>
  ...
  function calcRoute() {
      ...
      directionsService.route(request, function (response, status) {
          if (status == google.maps.DirectionsStatus.OK) {
              ...
              for (i = 0; i < legs.length; i++) {
                  if (i === 0) {
                      ...
                      startLocation.address = legs[i].start_address;
                        // marker = createMarker(legs[i].start_location, "mid", legs[i].start_address, "green");
                  }
            ...
            const iconBase = "{{asset('backend/img/trucks')}}";
            const icons = {
              info: {
            ...
            const features = [
              {
                position: new google.maps.LatLng(22.10571491253143, 79.54753098040064),
                type: "info",
              }
            ];
  ...
  var icon = {
    //   path: car,
      url: "{{ asset('backend/img/trucks/blue-01.png') }}",
      scale: .7,
      strokeColor: 'white',
      strokeWeight: .10,
      fillOpacity: 1,
