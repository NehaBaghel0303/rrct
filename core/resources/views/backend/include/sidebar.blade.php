    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <div class="px-20px mt-3 mb-3">
                <input class="form-control bg-soft-secondary border-0 form-control-sm text-white" style="background-color: #131923;border-color: #131923;" type="text" name="" placeholder="{{ __('Search') }}" id="menu-search" onkeyup="menuSearch()">
            </div>
            ...
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                @if(auth()->user()->roles[0]->name != 'Super Admin')
                   ...
                   @include('backend.include.partial.manager_sidebar')
                @endif
