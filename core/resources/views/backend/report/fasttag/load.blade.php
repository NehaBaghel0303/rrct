        ...
        <div class="d-flex">
            ...
            <div style="position:relative;">
                ...
                <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                    <li class="dropdown-item p-0 col-btn" data-val="col_1"><a href="javascript:void(0);"  class="btn btn-sm">Veh No.</a></li>
                    ...
                    <li class="dropdown-item p-0 col-btn" data-val="col_8"><a href="javascript:void(0);"  class="btn btn-sm">Tot. Toll Both Count</a></li>
                    <li class="dropdown-item p-0 col-btn" data-val="col_9"><a href="javascript:void(0);"  class="btn btn-sm">Tot. FastTag Amt</a></li>
                    <li class="dropdown-item p-0 col-btn" data-val="col_10"><a href="javascript:void(0);"  class="btn btn-sm">Actual Toll Both Count</a></li>
                    <li class="dropdown-item p-0 col-btn" data-val="col_11"><a href="javascript:void(0);"  class="btn btn-sm">Actual FastTag Amt</a></li>
                    <li class="dropdown-item p-0 col-btn" data-val="col_12"><a href="javascript:void(0);"  class="btn btn-sm">Variance/ Diff Amt</a></li>
        ...
        <table id="table" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th  class="col_3" data-toggle="tooltip" data-placement="top"  title="Invoice no">Inv no</th>
                    ...
                    <th  class="col_8" data-toggle="tooltip" data-placement="top" title="Total Toll Both Count">TTBC</th>
                    <th  class="col_9" data-toggle="tooltip" data-placement="top" title="Total FastTag Amt">TFTA</th>
                    <th  class="col_10" data-toggle="tooltip" data-placement="top" title="Actual Toll Both Count">ATBC</th>
                    <th  class="col_11" data-toggle="tooltip" data-placement="top" title="Actual FastTag Amt">AFTA</th>
                    <th  class="col_12" data-toggle="tooltip" data-placement="top" title="Variance/ Difference Amt">V/D Amt</th>
                    <th  class="col_13" data-toggle="tooltip" data-placement="top" title="Remarks">Remark</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td class="col_8">{{ $item->item->tot_toll_both_cont }}</td>
                        <td class="col_9">{{ $item->item->act_toll_both_count }}</td>
                        <td class="col_10">{{ $item->item->tot_ft_amt }}</td>
                        <td class="col_11">{{ $item->item->act_ft_amt }}</td>
...
{{-- Right Off Canvas --}}
@include('backend.report.update-remark',['type'=>"fasttag"])
@include('backend.report.fasttag.filter')
