            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="invoice_no" placeholder="Enter..">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                ...
                <div class="col-12">
                    <div class="form-group">
                        <label for="">Actual Diesel Ltr</label>
                        <input type="text" class="form-control" name="actual_diesel_ltr" placeholder="Enter..">
                    </div>
                </div>
                </div>
                <div class="col-12">
