        ...
        <table id="table" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th  class="col_1" data-toggle="tooltip" data-placement="top" title="Customer">Customer</th>
                    
                    <th  class="col_4" data-toggle="tooltip" data-placement="top" title="Duration">Duration</th>
...
@include('backend.report.update-remark',['type'=>'delay_eta_at_er'])
{{-- Right Off Canvas --}}
@include('backend.report.delay-at-en-route.filter')
