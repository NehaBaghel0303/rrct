        ...
        <table id="table" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th  class="col_2" data-toggle="tooltip" data-placement="top" title="C">Customer</th>
                    <th  class="col_3" data-toggle="tooltip" data-placement="top" title="Delay">Delay</th>
            ...
            <tbody>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td class="col_3">{{ $item->item->delay }}</td>  
                        <td class="col_13">
...
@include('backend.report.update-remark',['type'=>'delay_eta'])
{{-- Right Off Canvas --}}
@include('backend.report.delay-eta.filter')
