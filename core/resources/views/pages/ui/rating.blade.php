...
@section('content')
    ...
    @push('head')
        ...
        <link rel="stylesheet" href="{{ asset('backend/plugins/jquery-bar-rating/dist/themes/bars-1to10.css')}}">
        <link rel="stylesheet" href="{{ asset('backend/plugins/jquery-bar-rating/dist/themes/bars-horizontal.css')}}">
        <link rel="stylesheet" href="{{ asset('backend/plugins/jquery-bar-rating/dist/themes/bars-movie.css')}}">
        <link rel="stylesheet" href="{{ asset('backend/plugins/jquery-bar-rating/dist/themes/bars-pill.css')}}">
        <link rel="stylesheet" href="{{ asset('backend/plugins/jquery-bar-rating/dist/themes/bars-reversed.css')}}">
        <link rel="stylesheet" href="{{ asset('backend/plugins/jquery-bar-rating/dist/themes/bars-square.css')}}">
        <link rel="stylesheet" href="{{ asset('backend/plugins/jquery-bar-rating/dist/themes/css-stars.css')}}">
        <link rel="stylesheet" href="{{ asset('backend/plugins/jquery-bar-rating/dist/themes/fontawesome-stars.css')}}">
        <link rel="stylesheet" href="{{ asset('backend/plugins/jquery-bar-rating/dist/themes/fontawesome-stars-o.css')}}">
    @endpush
    ...
    <!-- push external js -->
    @push('script')
        <script src="{{ asset('backend/plugins/jquery-bar-rating/dist/jquery.barrating.min.js')}}"></script>
        
        <script src="{{ asset('backend/js/rating.js')}}"></script>
    @endpush
@endsection
