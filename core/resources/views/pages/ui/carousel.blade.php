...
@section('content')
                            ...
                            <div class="owl-carousel basic">
                                <div class="card flex-row">
                                    <div class="w-50 position-relative">
                                        <img class="card-img-left" src="{{ asset('backend/img/portfolio-1.jpg')}}" alt="Card image cap">
                                ...
                                <div class="card flex-row">
                                    <div class="w-50 position-relative">
                                        <img class="card-img-left" src="{{ asset('backend/img/portfolio-2.jpg')}}" alt="Card image cap">
                                ...
                                <div class="card flex-row">
                                    <div class="w-50 position-relative">
                                        <img class="card-img-left" src="{{ asset('backend/img/portfolio-3.jpg')}}" alt="Card image cap">
                                        <span class="badge badge-pill badge-primary position-absolute badge-top-left">New</span>
                                    </div>
                                    <div class="w-50">
                                        <div class="card-body">
                                ...
                                <div class="card flex-row">
                                    <div class="w-50 position-relative">
                                        <img class="card-img-left" src="{{ asset('backend/img/portfolio-4.jpg')}}" alt="Card image cap">
                                        <span class="badge badge-pill badge-primary position-absolute badge-top-left">New</span>
                                    </div>
                                    <div class="w-50">
                                        <div class="card-body">
                                ...
                                <div class="card flex-row">
                                    <div class="w-50 position-relative">
                                        <img class="card-img-left" src="{{ asset('backend/img/portfolio-5.jpg')}}" alt="Card image cap">
                                        <span class="badge badge-pill badge-primary position-absolute badge-top-left">New</span>
                                    </div>
                                    <div class="w-50">
                                        <div class="card-body">
                                ...
                                <div class="card flex-row">
                                    <div class="w-50 position-relative">
                                        <img class="card-img-left" src="{{ asset('backend/img/portfolio-6.jpg')}}" alt="Card image cap">
                                        <span class="badge badge-pill badge-primary position-absolute badge-top-left">New</span>
                                    </div>
                                    <div class="w-50">
                                        <div class="card-body">
                        ...
                        <div class="owl-container">
                            <div class="owl-carousel single">
                                <div class="card d-flex flex-row">
                                    <a class="d-flex" href="#">
                                        <img alt="Thumbnail" src="{{ asset('backend/img/portfolio-7.jpg')}}" class="list-thumbnail responsive border-0">
                                    </a>
                                ...
                                <div class="card d-flex flex-row">
                                    <a class="d-flex" href="#">
                                        <img alt="Thumbnail" src="{{ asset('backend/img/portfolio-8.jpg')}}" class="list-thumbnail responsive border-0">
                                    </a>
                                    <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                                        <div class="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero">
                                            <a href="#">
                                ...
                                <div class="card d-flex flex-row">
                                    <a class="d-flex" href="#">
                                        <img alt="Thumbnail" src="{{ asset('backend/img/portfolio-9.jpg')}}" class="list-thumbnail responsive border-0">
                                    </a>
                                    <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                                        <div class="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero">
                                            <a href="#">
    ...
    @push('script')
        ...
        <script src="{{ asset('backend/js/carousel.js')}}"></script>
    @endpush
@endsection
